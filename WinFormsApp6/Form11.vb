Public Class Form11
    ...
    Dim startX As Integer = 424
    Dim startY As Integer = 454
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        If canMove Then
            MoveVertical(Red1, 239, 711, Red1GoingDown, Red1GoingDown)
            MoveVertical(Red2, 239, 711, Red2GoingDown, Red2GoingDown)
            MoveVertical(Cat1, 239, 599, Cat1GoingDown, Cat1GoingDown)
            MoveHorizontal(Red3, 1342, 1466, Red3GoingRight, Red3GoingRight)
            MoveHorizontal(Red4, 1342, 1466, Red4GoingRight, Red4GoingRight)
            MoveHorizontal(Red5, 1342, 1466, Red5GoingRight, Red5GoingRight)
            MoveHorizontal(Red6, 1342, 1466, Red6GoingRight, Red6GoingRight)
